...
;; Idiom: 3 simultaneous negative lookbehinds  AND_i (?<!ab|cd|ef) [0-9]+ .
...
;;==========================================================================
(define-fun lang () (RegEx String)   ;; intersection of 3 neg-lookbehinds, each . [0-9]+
  (re.inter (re.++ (re.comp (re.++ (re.* re.allchar) (str.to_re "ab"))) (re.+ (re.range "0" "9"))) (re.inter (re.++ (re.comp (re.++ (re.* re.allchar) (str.to_re "cd"))) (re.+ (re.range "0" "9"))) (re.++ (re.comp (re.++ (re.* re.allchar) (str.to_re "ef"))) (re.+ (re.range "0" "9"))))))
