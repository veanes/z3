...
;; Idiom: 2 simultaneous negative lookbehinds  AND_i (?<!ab|cd) [a-z]+ .
...
;;==========================================================================
(define-fun lang () (RegEx String)   ;; intersection of 2 neg-lookbehinds, each . [a-z]+
  (re.inter (re.++ (re.comp (re.++ (re.* re.allchar) (str.to_re "ab"))) (re.+ (re.range "a" "z"))) (re.++ (re.comp (re.++ (re.* re.allchar) (str.to_re "cd"))) (re.+ (re.range "a" "z")))))
