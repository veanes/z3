...
;;==========================================================================
(define-fun inner () (RegEx String)  ;; ~(Sigma* "ab") . "cd"
  (re.++ (re.comp (re.++ (re.* re.allchar) (str.to_re "ab"))) (str.to_re "cd")))
(define-fun lang () (RegEx String)   ;; ~(Sigma* inner) . [a-z]+
  (re.++ (re.comp (re.++ (re.* re.allchar) (re.++ (re.comp (re.++ (re.* re.allchar) (str.to_re "ab"))) (str.to_re "cd")))) (re.+ (re.range "a" "z"))))
