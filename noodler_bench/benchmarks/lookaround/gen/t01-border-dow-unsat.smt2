...
;;   alternation = mon | tue | wed | thu | fri
;; Vars: x (x2), y ; layout xyx = x.y.x
;; Query: x in Sigma+ ;  x.y.x in ( mon | tue | wed | thu | fri )
...
(define-fun alt () (RegEx String)
  (re.union (str.to_re "mon") (re.union (str.to_re "tue") (re.union (str.to_re "wed") (re.union (str.to_re "thu") (str.to_re "fri"))))))
