...
(set-info :status sat)
;; ==========================================================================
;; Multivariable membership (generated) -- modular length ([0-9a-f]{5})+, difficulty L2
;; Idiom: length-modulo look-ahead (?=([0-9a-f]{5})+) (grouping / chunking).
;; Vars: x (x2), y ; layout xyx
;; Query: x in [0-9a-f]+, y in [0-9a-f]* ; x.y.x in ([0-9a-f]{5})+
