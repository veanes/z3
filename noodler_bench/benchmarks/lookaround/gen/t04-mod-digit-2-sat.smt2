...
(set-info :status sat)
;; ==========================================================================
;; Multivariable membership (generated) -- modular length ([0-9]{2})+, difficulty L2
;; Idiom: length-modulo look-ahead (?=([0-9]{2})+) (grouping / chunking).
;; Vars: x (x2), y ; layout xyx
;; Query: x in [0-9]+, y in [0-9]* ; x.y.x in ([0-9]{2})+
