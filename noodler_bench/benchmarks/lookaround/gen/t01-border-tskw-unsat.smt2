...
;;   alternation = keyof | infer | typeof | readonly
;; Vars: x (x2), y ; layout xyx = x.y.x
;; Query: x in Sigma+ ;  x.y.x in ( keyof | infer | typeof | readonly )
...
(define-fun alt () (RegEx String)
  (re.union (str.to_re "keyof") (re.union (str.to_re "infer") (re.union (str.to_re "typeof") (str.to_re "readonly")))))
