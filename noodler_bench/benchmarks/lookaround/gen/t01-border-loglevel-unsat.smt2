...
;;   alternation = debug | info | warn | error
;; Vars: x (x2), y ; layout xyx = x.y.x
;; Query: x in Sigma+ ;  x.y.x in ( debug | info | warn | error )
...
(define-fun alt () (RegEx String)
  (re.union (str.to_re "debug") (re.union (str.to_re "info") (re.union (str.to_re "warn") (str.to_re "error")))))
